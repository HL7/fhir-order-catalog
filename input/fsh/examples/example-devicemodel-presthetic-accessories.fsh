...
* packaging[0].type.coding[0] = http://snomed.info/sct#37284003 "Bag, device"
...
* packaging[0].packaging[0].type.coding[0] = http://snomed.info/sct#37284003 "Bag, device"
...
* safety[0].coding[0] = urn:oid:2.16.840.1.113883.3.26.1.1#C113844 "Labeling does not Contain MRI Safety Information"	
* languageCode = http://terminology.hl7.org/CodeSystem/iso639-1#en-US "American English"  
